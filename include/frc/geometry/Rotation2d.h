...
class Rotation2d {
 public:
   ...
   */
  Rotation2d(okapi::radian value);  // NOLINT(runtime/explicit)
   ...
   */
  okapi::radian Radians() const { return m_value; }
   ...
   */
  okapi::degree Degrees() const { return m_value; }
