...
class Translation2d {
 public:
   ...
   */
  Translation2d(okapi::meter x, okapi::meter y);
   ...
   */
  okapi::meter Distance(const Translation2d& other) const;
   ...
   */
  okapi::meter X() const { return m_x; }
   ...
   */
  okapi::meter Y() const { return m_y; }
