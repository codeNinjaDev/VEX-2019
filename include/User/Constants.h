...
const int FRONT_RIGHT_MOTOR_PORT = 14;
const int BACK_LEFT_MOTOR_PORT = 10;
const int BACK_RIGHT_MOTOR_PORT = 1;

const int TRAY_MOTOR_PORT = 9;

const int LEFT_INTAKE_MOTOR_PORT = 8;
const int RIGHT_INTAKE_MOTOR_PORT = 3;

const int ARM_MOTOR_PORT = 11;
